...
const RegularFont = fetch(new URL("../../../fonts/Inter-Bold.ttf", import.meta.url)).then((res) => res.arrayBuffer());
...
export default async function handler(req: { url: string }) {
    try {
        ...
        const { bannerImage, genres, coverImage, averageRating, year, status } = data;
