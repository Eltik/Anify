...
const Novel: NextPage<Props> = ({ seasonal, recent }) => {
    ...
    return (
        <>
            <Head>
                <title>{"Novels"}</title>
                <meta name="title" content={"Novels"} />
                <meta name="description" content={"Read novels by the chapter to catch up with your favorite series."} />

                <meta property="og:type" content="website" />
                <meta property="og:url" content={`https://anify.tv/novels`} />
                <meta property="og:title" content={"Novels"} />
                <meta property="og:description" content={"Read novels by the chapter to catch up with your favorite series."} />
                <meta property="og:image" content={""} />

                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content={`https://anify.tv/novels`} />
                <meta property="twitter:title" content={"Novels"} />
                <meta property="twitter:description" content={"Read novels by the chapter to catch up with your favorite series."} />
                <meta property="twitter:image" content={""} />
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Sidebar active="novel" />
            <Navbar active="novel" />
            <main>
...
export const getServerSideProps: GetServerSideProps = async () => {
    const seasonal = (await axios.get(String(env.BACKEND_URL) + "/seasonal?type=novel&fields=[id,description,bannerImage,coverImage,title,genres,format,averageRating,episodes,chapters,year,type]&apikey=" + String(env.API_KEY))).data as Seasonal;
    const recent = (await axios.get(String(env.BACKEND_URL) + "/recent?type=novel&apikey=" + String(env.API_KEY))).data as Manga[];
