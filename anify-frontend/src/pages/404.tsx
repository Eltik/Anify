                ...
                <div className="relative flex items-center min-h-screen overflow-hidden">
                    ...
                    <div className="relative text-center space-y-16 container xl:max-w-7xl mx-auto px-8 py-16 lg:py-32 z-10">
                        <div>
                            ...
                            <span className="text-6xl md:text-7xl font-extrabold text-main-text">404</span>
                            <div className="w-12 h-1.5 rounded-lg mx-auto my-6 md:my-10 bg-gray-400" />
                            <h1 className="text-2xl md:text-3xl font-extrabold mb-3 text-main-light">Page not found!</h1>
                            <div className="md:leading-relaxed font-medium text-2xl lg:w-4/5 mx-auto text-main-text">Oops! Looks like the page you are looking for couldn&apos;t be found. We&apos;re working on it to get things back on track. Try refreshing the page or come back later.</div>
                        </div>
